/*
From: Kärkkäinen, Juha, and Peter Sanders. "Simple linear work suffix array construction."
...
DLLEXPORT void suffixArray(int* s, int* SA, int n, int K) {
